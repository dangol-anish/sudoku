...
//Gtk callback function header file checks this part//
...
int main(int argc,char *argv[]){
    ...
    /* static storage, value exists in function call and remains in memory */
    static char *File[4] = {"New Game","Save","Open","Quit"};
    ...
    gtk_box_pack_start(GTK_BOX(vbox),button,1,0,2);
